# Target file: tests/test_end_to_end_swag_labs_complete_shopping_and_authentication_journey.py
...
class ProductDetailPage:
    ...
    def click_the_shopping_cart_link(self, page: Page, test_data: dict) -> None:
...
class ContentPage:
    ...
    def enter_90210_into_the_zip_postal_code_field(self, page: Page, test_data: dict) -> None:
...
class CheckoutCompletePage:
    ...
    LOCATOR_2 = 'a[data-test="social-facebook"]'

    def click_the_open_menu_button(self, page: Page, test_data: dict) -> None:
        page.locator('#react-burger-menu-btn').click()

    def click_the_logout_sidebar_link(self, page: Page, test_data: dict) -> None:
        page.locator('a[data-test="social-facebook"]').click()


def test_end_to_end_swag_labs_complete_shopping_and_authentication_journey(page: Page, vtest_base_url: str, test_data: dict) -> None:
    ...
    product_detail_page.click_the_shopping_cart_link(page, test_data)
    ...
    content_page.enter_90210_into_the_zip_postal_code_field(page, test_data)
    ...
    checkout_complete_page.click_the_logout_sidebar_link(page, test_data)

    expect(page.locator('body')).to_contain_text('All Items')